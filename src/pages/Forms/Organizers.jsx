      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 sm:py-24 lg:py-32 flex flex-col lg:flex-row gap-16">
        ...
        <section className="lg:w-1/2 flex flex-col justify-center text-white space-y-8">
          ...
          <p className="text-lg sm:text-xl max-w-lg opacity-90">
            Partner with us to create unforgettable hackathons that foster creativity, collaboration, and community growth. Join a network of forward-thinking organizers making an impact.
          </p>
        ...
        <section className="lg:w-1/2 bg-white bg-opacity-10 backdrop-blur-2xl rounded-xl shadow-2xl p-10 max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-6 text-white">
            <input type="hidden" name="organizerId" value={formData.organizerId} />

            <div>
              <label htmlFor="instituteType" className="block text-sm font-medium">
              ...
              <select
                ...
                required
                className={`mt-1 block w-full rounded-md bg-white bg-opacity-20 border border-white border-opacity-30 shadow-sm text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition duration-150 ${
              ...
              {errors.instituteType && (
                <p className="mt-1 text-sm text-red-400">{errors.instituteType}</p>
              )}
            </div>

            <div>
              <label htmlFor="instituteName" className="block text-sm font-medium">
              ...
              {errors.instituteName && (
                <p className="mt-1 text-sm text-red-400">{errors.instituteName}</p>
              )}
            </div>
            ...
            <div>
              <label htmlFor="hackathonType" className="block text-sm font-medium">
              ...
              {errors.hackathonType && (
                <p className="mt-1 text-sm text-red-400">{errors.hackathonType}</p>
              )}
            </div>
            ...
            <div>
              <button
                type="submit"
                disabled={submitting}
                className="w-full flex justify-center py-3 px-6 border border-transparent rounded-md shadow-lg text-white bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-600 hover:from-indigo-600 hover:via-purple-700 hover:to-pink-700 focus:outline-none focus:ring-4 focus:ring-indigo-400 focus:ring-opacity-50 transition duration-150 disabled:opacity-50 disabled:cursor-not-allowed font-semibold text-lg"
              >
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-12 flex flex-col items-center space-y-6 text-white">
        ...
        <div className="text-center max-w-xl">
          ...
          <button
            ...
            className="inline-block px-8 py-3 rounded-full bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-600 hover:from-indigo-600 hover:via-purple-700 hover:to-pink-700 text-white font-semibold shadow-lg transition duration-150"
            type="button"
          >
